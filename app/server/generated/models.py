...
class Documents(RootModel[Union[DocumentLink, DocumentText, DocumentContent]]):
...
class RedactionRequest(BaseModel):
    jurisdictionId: str
    caseId: str
    accuseds: List[Accused] = Field(..., min_length=1)
...
class BlindReviewInfo(BaseModel):
    ...
    maskedAccuseds: List[MaskedAccused]
    redactedDocuments: List[Union[DocumentLink, DocumentContent]] = Field(
        ..., discriminator='attachmentType'
    )
...
class RedactionResultSuccess(BaseModel):
    ...
    caseId: str
    maskedAccuseds: List[MaskedAccused]
    redactedDocument: Union[DocumentLink, DocumentContent] = Field(
        ..., discriminator='attachmentType'
    )
